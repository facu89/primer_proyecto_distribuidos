...
start "NAME SERVER" cmd /k "title NAME SERVER && python nameserver.py --host 127.0.0.1 --port 9090"

ping -n 3 127.0.0.1 >nul

echo 2. Levantando Central 1 (Principal)...
start "CENTRAL 1 - Principal" cmd /k "title CENTRAL 1 && python central.py 1 --host 127.0.0.1 --port 8080 --ns-host 127.0.0.1 --ns-port 9090 --http-port 5000 --peers-http 2:127.0.0.1:5001"

ping -n 2 127.0.0.1 >nul

echo 3. Levantando Central 2 (Respaldo)...
start "CENTRAL 2 - Respaldo" cmd /k "title CENTRAL 2 && python central.py 2 --host 127.0.0.1 --port 8081 --ns-host 127.0.0.1 --ns-port 9090 --http-port 5001 --peers-http 1:127.0.0.1:5000"
