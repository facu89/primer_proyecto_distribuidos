...
set NS_PORT=9090
set CENTRAL1_HTTP=192.168.1.53:5000
REM ============================================================

title CENTRAL 2
python central.py 2 --host %MI_HOST% --port 8081 --ns-host %NS_HOST% --ns-port %NS_PORT% --http-port 5001 --peers-http 1:%CENTRAL1_HTTP%
