@echo off
REM ============================================================
REM  CONFIGURACION: correr en la maquina de la Central 2.
...
REM  CENTRAL1_HTTP = IP:puerto del dashboard de la Central 1, para que el
REM  navegador pueda redirigir solo ahi si esta Central se cae.
set MI_HOST=192.168.88.206
set NS_HOST=192.168.88.206
set NS_PORT=9090
set CENTRAL1_HTTP=192.168.88.206:5000
REM ============================================================

title CENTRAL 2
python3 central.py 2 --host %MI_HOST% --port 8081 --ns-host %NS_HOST% --ns-port %NS_PORT% --http-port 5001 --peers-http 1:%CENTRAL1_HTTP%
